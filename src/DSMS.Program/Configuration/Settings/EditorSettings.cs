...
public class SystemTab
{
    ...
    public SystemTab(DSMS baseEditor)
    {
...
public class MapEditorTab
{
    ...
    public MapEditorTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
...
public class ModelEditorTab
{
    ...
    public ModelEditorTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
...
public class TextEditorTab
{
    ...
    public TextEditorTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
...
public class ParamEditorTab
{
    ...
    public ParamEditorTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
...
public class GparamEditorTab
{
    ...
    public GparamEditorTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
...
public class EmevdEditorTab
{
    ...
    public EmevdEditorTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
...
public class EsdEditorTab
{
    ...
    public EsdEditorTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
...
public class TextureViewerTab
{
    ...
    public TextureViewerTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
...
public class TimeActEditorTab
{
    ...
    public TimeActEditorTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
...
public class InterfaceTab
{
    ...
    public InterfaceTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
...
public class ViewportTab
{
    ...
    public ViewportTab(DSMS baseEditor)
    {
        BaseEditor = baseEditor;
    }
