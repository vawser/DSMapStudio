...
public class DSMS
{
    ...
    public unsafe DSMS(IGraphicsContext context, string version, bool isLowRequirements)
    {
    ...
    private unsafe void Update(float deltaseconds)
    {
        ...
        if (ImGui.BeginMainMenuBar())
        {
            ...
            // Program Update
            if (DSMS._programUpdateAvailable)
            {
                ...
                if (ImGui.Button("Update Available"))
                {
                    ...
                    myProcess.StartInfo.FileName = DSMS._releaseUrl;
                    myProcess.Start();
                }
