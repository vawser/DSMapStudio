...
public class MapBank
{
    ...
    public MapBank(string name, DSMS baseEditor, ProjectEntry project, VirtualFileSystem targetFs)
    {
...
public class MapWrapper
{
    ...
    public MapWrapper(DSMS baseEditor, ProjectEntry project, FileDictionaryEntry dictEntry, VirtualFileSystem targetFS)
    {
        BaseEditor = baseEditor;
        Project = project;
        TargetFS = targetFS;
