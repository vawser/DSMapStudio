...
public static class DokuWikiGenerator
{
    ...
    public static void OutputParamTableInformation(DSMS baseEditor, ProjectEntry curProject)
    {
    ...
    public static void OutputParamInformation(DSMS baseEditor, ProjectEntry project, string paramKey)
    {
        var editor = baseEditor.ProjectManager.SelectedProject.ParamEditor;
