...
public static class ParamValidator
{
    ...
    public static void Display(DSMS baseEditor, ProjectEntry project)
    {
        if (project == null)
            return;
    ...
    public static void ValidatePadding(DSMS baseEditor, ProjectEntry project, bool allParams = false)
    {
        if (allParams)
        {
    ...
    public static void ValidatePaddingForParam(DSMS baseEditor, ProjectEntry project, string selectedParamName)
    {
    ...
    public static void ValidateParamdef(DSMS baseEditor, ProjectEntry curProject)
    {
