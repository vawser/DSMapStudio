...
internal class ParamReloader
{
        ...
        SoulsMemoryHandler handler)
    {
        ...
        foreach (var param in paramNames)
        {
            ...
            if (Project.Type is ProjectType.DS1 or ProjectType.DS1R &&
                param == "ThrowParam")
    ...
    {
        if (!GameOffsets.GameOffsetBank.ContainsKey(Project.Type))
            try
            {
                GameOffsets.GameOffsetBank.Add(Project.Type, new GameOffsets());
            }
            catch (Exception e)
            {
        ...
        return GameOffsets.GameOffsetBank[Project.Type];
    }
...
internal class GameOffsets
{
    ...
    internal GameOffsets()
    {
        ...
        Is64Bit = Project.Type != ProjectType.DS1;
