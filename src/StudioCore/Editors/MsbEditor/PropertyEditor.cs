...
public class PropertyEditor
{
        ...
        else if (typ == typeof(Color))
        {
            ...
            if (att != null)
                if (att.Supports == false)
                {
                    ...
                    {
                        var newColor = Color.FromArgb((int)(val.X * 255.0f), (int)(val.Y * 255.0f),
                            (int)(val.Z * 255.0f));
                        newval = newColor;
                        isChanged = true;
                    }
                ...
                else
                {
                    ...
                    {
                        var newColor = Color.FromArgb((int)(val.W * 255.0f), (int)(val.X * 255.0f),
    ...
    {
        var attributes = propinfo.GetCustomAttributes<MSBParamReference>().ToList();
        if (attributes.Any())
        {
