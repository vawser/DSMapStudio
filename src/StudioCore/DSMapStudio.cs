...
public class DSMapStudio
{
    ...
    public unsafe DSMapStudio(IGraphicsContext context, string version)
    {
        _version = version;
        _programTitle = $"DSMS - Version {_version}";
    ...
    private unsafe void SetupFonts()
    {
        ...
        // Other language fonts
        {
            ...
            foreach (var c in SpecialCharsJP)
            {
    ...
    private unsafe void Update(float deltaseconds)
    {
        ...
        if (WindowContainer.SettingsWindow.FontRebuildRequest)
        {
            _context.ImguiRenderer.Update(deltaseconds, InputTracker.FrameSnapshot, SetupFonts);
            WindowContainer.SettingsWindow.FontRebuildRequest = false;
        }
        else
        {
