...
public class HelpWindow
{
    ...
    public void Display()
    {
        ...
        ImGui.PushStyleColorVec4(ImGuiCol.WindowBg, CFG.Current.Imgui_Moveable_MainBg);
        ImGui.PushStyleColorVec4(ImGuiCol.TitleBg, CFG.Current.Imgui_Moveable_TitleBg);
        ImGui.PushStyleColorVec4(ImGuiCol.TitleBgActive, CFG.Current.Imgui_Moveable_TitleBg_Active);
        ImGui.PushStyleColorVec4(ImGuiCol.ChildBg, CFG.Current.Imgui_Moveable_ChildBg);
        ImGui.PushStyleColorVec4(ImGuiCol.Text, CFG.Current.ImGui_Default_Text_Color);
        ...
        if (ImGui.Begin("Help##Popup", ref MenuOpenState, ImGuiWindowFlags.NoDocking))
        {
            ...
            ImGui.PushStyleColorVec4(ImGuiCol.Header, CFG.Current.Imgui_Moveable_Header);
        ...
        string inputStrCache, string title, string noSelection_Title, string noSelection_Body)
    {
        ...
        if (ImGui.BeginTabItem(title))
        {
            ...
            // Selection Area
            ImGui.BeginChild($"{title}SectionList", new Vector2(600, 100), ImGuiChildFlags.None, ImGuiWindowFlags.NoScrollbar);
